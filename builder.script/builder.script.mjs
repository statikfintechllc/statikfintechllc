...
const outputDir = "docs/Zenodo.papers.svg/";
...
function createSVGCard(article, index) {
  ...
  <g transform="translate(${padding},${padding})">
    ...
    <!-- Zenodo Z letter -->
    <text x="65" y="78" text-anchor="middle" font-family="Arial, sans-serif" font-size="36" font-weight="700" fill="#ffffff">Z</text>
    <!-- Small academic dots for scholarly appearance -->
