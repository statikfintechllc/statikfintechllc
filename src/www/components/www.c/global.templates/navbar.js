    ...
    constructor(config = {}) {
        const wwwConfig = {
            ...
            items: [
                ...
                { title: 'PWAs', href: 'https://statikfintechllc.github.io/statikfintechllc/dev.sfti-ai.org.html', external: true, description: 'Progressive Web Applications hub' },
                { title: 'Server', href: 'https://statikfintechllc.github.io/statikfintechllc/server.sfti-ai.org.html', external: true, description: 'Secure access portal' }
            ],
            cta: {
