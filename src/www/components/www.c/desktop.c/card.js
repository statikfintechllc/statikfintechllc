...
(function registerSFTiDomainBindings() {
    ...
    if (globalObj) {
        if (!globalObj['WwwCardDesktop']) {
            globalObj['WwwCardDesktop'] = DomainImplementation;
        }
        if (!globalObj['createWwwCardDesktop']) {
            globalObj['createWwwCardDesktop'] = (config = {}) => new DomainImplementation(config);
        }
