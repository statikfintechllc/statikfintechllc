...
// Institute Carousel functionality (smooth scrolling with wheel and drag support)
function initInstituteCarousel() {
    const carousel = document.querySelector('.institute-carousel');
...
function initResearchCarousels() {
    // Get all research carousels
    const carousels = document.querySelectorAll('.papers-carousel');
