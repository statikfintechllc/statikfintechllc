 ...
 * Generated: 2025-10-19T00:07:55.098Z
 */
...
(function registerSFTiDomainBindings() {
    ...
    if (globalObj) {
        if (!globalObj['ServerCardDesktop']) {
            globalObj['ServerCardDesktop'] = DomainImplementation;
        }
        if (!globalObj['createServerCardDesktop']) {
            globalObj['createServerCardDesktop'] = (config = {}) => new DomainImplementation(config);
        }
