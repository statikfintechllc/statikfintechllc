 ...
 * Generated: 2025-09-29T03:18:19.013Z
 */
...
(function registerSFTiDomainBindings() {
    ...
    if (globalObj) {
        if (!globalObj['DevCardDesktop']) {
            globalObj['DevCardDesktop'] = DomainImplementation;
        }
        if (!globalObj['createDevCardDesktop']) {
            globalObj['createDevCardDesktop'] = (config = {}) => new DomainImplementation(config);
        }
