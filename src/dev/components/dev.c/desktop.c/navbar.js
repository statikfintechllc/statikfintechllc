 ...
 * Generated: 2025-10-19T00:07:54.824Z
 */
...
(function registerSFTiDomainBindings() {
    ...
    if (globalObj) {
        if (!globalObj['DevNavbarDesktop']) {
            globalObj['DevNavbarDesktop'] = DomainImplementation;
        }
        if (!globalObj['createDevNavbarDesktop']) {
            globalObj['createDevNavbarDesktop'] = (config = {}) => new DomainImplementation(config);
        }
