...
(function registerSFTiDomainBindings() {
    ...
    if (globalObj) {
        if (!globalObj['DevCardMobile']) {
            globalObj['DevCardMobile'] = DomainImplementation;
        }
        if (!globalObj['createDevCardMobile']) {
            globalObj['createDevCardMobile'] = (config = {}) => new DomainImplementation(config);
        }
