...
const OUTPUT = path.resolve("assets/sfti-homepage-card.svg");
...
<svg width="480" height="230" viewBox="0 0 480 230" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <!-- Title -->
  <text x="48" y="31" class="title">SFTi Home-Page</text>

  <!-- Main Call-to-Action -->
  <text x="240" y="100" class="cta" text-anchor="middle">Visit the SFTi Home-Page</text>
  ...
  <foreignObject x="48" y="120" width="380" height="70">
    <div xmlns="http://www.w3.org/1999/xhtml"
      ...
      Explore StatikFinTech, LLC's comprehensive platform for AI-powered trading solutions, financial technology innovations, Cool Programming projects, and cutting-edge development tools.
    </div>
  </foreignObject>
...
`.trim();
  ...
  console.log("✅ sfti-homepage-card.svg generated");
}
