// build-medium-cards.mjs
import { writeFileSync, mkdirSync } from "fs";
import { join } from "path";

const outputDir = "../Medium.papers.svg/";
mkdirSync(outputDir, { recursive: true });

const articles = [
  {
    title: "The AI Revolution That Wasn't",
    url: "https://medium.com/@ascend.gremlin/the-ai-revolution-that-wasnt-e8bbfd74681b",
    description: "Exploring how Big AI Roll-Backs Bottle-Neck Innovation."
  },
  {
    title: "Garbage In, Profits Out",
    url: "https://medium.com/@ascend.gremlin/garbage-in-profits-out-9032a4425bc5",
    description: "How Corporate AI Sustains Systemic Disinformation."
  },
  {
    title: "The Journey to SNHU",
    url: "https://medium.com/@ascend.gremlin/the-journey-to-snhu-e91c4aa11080",
    description: "From No Credentials to Heard by Credentials."
  }
];
...
function createSVGCard(article, index) {
  ...
  <!-- Medium Logo (modern M icon with publishing styling) -->
  <g transform="translate(${padding},${padding})">
    <!-- Background circle with Medium green -->
    <circle cx="65" cy="65" r="35" fill="#00ab6c"/>
    <!-- Medium M letter -->
    <text x="65" y="78" text-anchor="middle" font-family="Arial, sans-serif" font-size="36" font-weight="700" fill="#ffffff">M</text>
    <!-- Small publishing dots for editorial appearance -->
    <circle cx="50" cy="45" r="2" fill="#ffffff" opacity="0.6"/>
    <circle cx="80" cy="45" r="2" fill="#ffffff" opacity="0.6"/>
    <circle cx="50" cy="85" r="2" fill="#ffffff" opacity="0.6"/>
    <circle cx="80" cy="85" r="2" fill="#ffffff" opacity="0.6"/>
  </g>
  ...
  <g transform="translate(${textStartX},${padding})">
    ...
    <text x="${remainingWidth/2}" y="50" text-anchor="middle" 
          ...
          fill="#00ab6c">📝 Medium Article Publication 📝</text>
    ...
    <text x="${remainingWidth/2}" y="100" text-anchor="middle" 
          ...
          fill="#7dd3af" opacity="0.7">${article.url}</text>
  </g>
</svg>`;
