...
const OUTPUT = path.resolve("assets/ascendnet-card.svg");
const USER = "statikfintechllc";
const REPO = "AscendNet";
...
async function main() {
  ...
  const avatarBase64 = await fetchAvatarAsBase64();
...
<svg width="480" height="230" viewBox="0 0 480 230" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <!-- Alternative: Direct image with base64 avatar -->
